...
# %% [markdown]
# Hypotheses: aggregating ATAC-seq data by peak counts removes "important information"
# Important information = whether a gene close by is upregulated, what the earliest events of gene regulation are, etc....
...
# %% [markdown]
# Also of interest:
# - https://www.biorxiv.org/content/10.1101/2022.03.16.484118v1
# - https://www.nature.com/articles/s41467-021-21765-5: Seems interesting at first, but actually isn't. It simply a window denoises a particular window using the surounding 6kb

# %% [markdown]
# Why do we actually use peaks? It's historical!
# - From bulk
...
#   - Where modeling intervals on sequences is just not easily done. But if you create a "gradient-proof" pipeline, you can do anything!
#   - However, we lose a lot of information
#

# %% [markdown]
# $$
# \begin{align} 
# P(X|\theta) &= P(start, end,chr|\theta) \\
