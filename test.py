...
fragments = chd.data.fragments.view.FragmentsView.from_fragments(parentfragments, regions, overwrite=True)
...
# %%
fragments.__class__ = chd.data.fragments.FragmentsView
...
# %%
np.allclose(fragments.counts, np.array([[1, 0, 0], [2, 1, 3], [2, 1, 1]]))
