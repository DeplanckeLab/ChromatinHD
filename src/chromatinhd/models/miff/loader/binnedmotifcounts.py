...
class Result:
    genecounts: torch.tensor
    binixs: torch.tensor
    global_binixs: torch.tensor
...
class BinnedMotifCounts:
    ...
    def __init__(
        ...
        self.region_width = self.motifcounts.region_width
    ...
    def load(self, minibatch, fragments):
        ...
        for binset_ix, (
            ...
            zip(
                ...
                [self.region_width, *self.motifcounts.fragment_binsizes[:-1]],
