...
class Decoding(torch.nn.Module):
    def __init__(self, fragments, cell_latent_space, nbins = (128, ), decoder_n_layers = 0, baseline = False):
        super().__init__()
        ...
        transform = DifferentialQuadraticSplineStack(x.cpu(), nbins = nbins, local_gene_ix = local_gene_ix.cpu(), n_genes = fragments.n_genes)
