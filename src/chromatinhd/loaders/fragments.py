...
class Result():
    ...
    def local_cell_ix(self):
        return torch.floor_divide(self.local_cellxgene_ix, self.n_genes)
...
class FragmentsCounting():
    ...
    def __init__(self, fragments, cellxgene_batch_size, window, n_fragment_per_cellxgene = None, n = (2, )):
        self.cellxgene_batch_size = cellxgene_batch_size
    ...
    def load(self, minibatch):
        ...
        assert len(minibatch.cellxgene_oi) <= self.cellxgene_batch_size
        if self.n == (2, ):
            n_fragments, *n_n = peakfreeatac.loaders.extraction.fragments.extract_fragments_counting(
                minibatch.cellxgene_oi,
                cellxgene_indptr,
                coordinates,
                genemapping,
            ...
            n_fragments, *n_n = peakfreeatac.loaders.extraction.fragments.extract_fragments_counting3(
                minibatch.cellxgene_oi,
                cellxgene_indptr,
                coordinates,
                genemapping,
