...
def create_bins_ordered(cells, genes, n_genes_total, n_genes_step = 300, n_cells_step = 1000, use_all = False, rg = None, permute_genes = True, permute_cells = True, **kwargs):
    """
...
def create_bins_random(cells, genes, n_genes_total, n_genes_step = 300, n_cells_step = 1000, use_all = False, rg = None, permute_genes = True, **kwargs):
    """
    Creates bins of cellxgene
...
class Minibatcher():
    ...
    def create_minibatches(self, *args, **kwargs):
        minibatches = create_bins_ordered(self.cells, self.genes, self.n_total_genes, n_genes_step = self.n_genes_step, n_cells_step=self.n_cells_step, permute_genes = False, *args, **kwargs)
        return minibatches